...
import { rbacAdminApi, type AuditLogQueryParams } from '../api/rbacAdminApi';
...
export const AuditLogsPage = () => {
  ...
  // useCallback so the effect below can depend on it honestly. Previously the
  // effect called loadLogs while omitting it from the dependency array, which
  // only happened to work because loadLogs closed over the same filters the
